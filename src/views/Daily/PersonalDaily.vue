  ...
  <div id = 'PersonalDaily'>
    <main class="container">
      ...
      <div  style="margin-top: 20px;display: flex;justify-content: space-between;">
        ...
        <section class="flex">
          <button v-if="permission.includes('prm1114')" class="btn btn_succ" style="width: 106px;height: 32px;margin-right: 20px" @click="allSubmit">
            <img src="../../assets/img/submit_all.png" alt="" style="width: 16px;height: 16px;">
            一键提交
          </button>
          <button v-if="permission.includes('prm1113')" class="btn btn_primary" style="width:76px;height:32px;" @click="$router.push({name:'edit'})">
              ...
              <el-table-column label="操作" align="center" width="220px">
                <template slot-scope="scope" >
                  <div class="main-around">
                    <span style="cursor: pointer;color:#5792FC;" @click.stop="toRoute(scope.row.id)" v-if="permission.includes('prm1115')">
                      <img src="../../assets/img/editor.png" alt="" style="width:13px;height:13px">
                      编辑
                    </span>
                    <span style="cursor: pointer;color:#5792FC;"  @click.stop='changeState(scope.row.id)' v-if="scope.row.state === 'DRAFT' && permission.includes('prm1114')">
                      <img src="../../assets/img/submit_personSub.png" alt="" style="width:13px;height:13px">
                      提交
                    </span>
                    <span style="cursor: pointer;color:#5792FC" @click.stop="deletePerson(scope.row.id,scope.row.state,scope.row.statistics)" v-if="permission.includes('prm1116')">
                      <img src="../../assets/img/trash.png" alt="" style="width:13px;height:13px">
                      删除
                    </span>
                    <span style="cursor: pointer;color:#5792FC" @click.stop="toRoute(scope.row.id, 'copy')" v-if="permission.includes('prm1113')">
            ...
            <el-table
              ...
              <el-table-column label="操作" align="center" width="200px">
                <template slot-scope="scope" class="flex">
                  <div class="main-around">
                    <span style="cursor: pointer;color:#5792FC" @click.stop="toRoute(scope.row.id)" v-if="scope.row.state === 'DRAFT' && permission.includes('prm1115')">
                      <img src="../../assets/img/editor.png" alt="" style="width: 13px;height: 13px;">
                      编辑
                    </span>
                    <span style="cursor: pointer;color:#5792FC;" @click.stop='changeState(scope.row.id)' v-if="scope.row.state === 'DRAFT' && permission.includes('prm1114')">
                    ...
                    <span style="cursor: pointer;color:#5792FC" @click.stop="deletePerson(scope.row.id,scope.row.state)" v-if=" permission.includes('prm1116')">
                      <img src="../../assets/img/trash.png" alt="" style="width: 13px;height: 13px;">
                      删除
                    </span>
                  </div>
