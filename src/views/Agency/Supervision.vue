  ...
  <main class="content">
    ...
    <div class="bg flex1" style="padding: 24px; box-sizing: border-box;">
      ...
      <div class="flex" style="margin-top: 28px;">
        ...
        <div :class="[tabActiveName === 'confirmedEvent' ? 'step1Item step1ItemActive' : 'step1Item']" @click="onChangeActiveTab('confirmedEvent')">待确认</div>
        ...
        <div :class="[tabActiveName === 'voidedEvent' ? 'step1Item step1ItemActive' : 'step1Item']" @click="onChangeActiveTab('voidedEvent')">已作废</div>
      </div>
...
export default class Supervision extends Vue {
  ...
  private onChangeActiveTab(tabName: any) {
    ...
    if (tabName === 'allEvent') {
      ...
      } else if (tabName === 'confirmedEvent') {
        this.tableData = [
          {
            id: 122222222222,
            compony: '北京**国有投资有限公司',
